...
$.openLayer = function(p){
    ...
    var fs = {
        ...
        init_style : function() {   //初始化css
            ...
            css.push("#headdiv {color:#666666;background-color:#cccccc;font-size:13px;height:25px;margin:1px;padding-bottom: 30px;" +aotu+"}");
            ...
            var d_css = "{width:"+_width+"px;margin:"+_margin+"px;padding:5px;height:auto;background-color:##E1E4DB;float:left;"+aotu+"}";
            css.push("dc "+d_css);
 ...
 //           var yPos = ($(window).height()-popupDiv.height()) / 2;
    // var xPos = ($(window).width()-popupDiv.width()) / 2;
           var yPos = param.clickPositionY;
           var xPos = param.clickPositionX;
